...
import registerIllustration from "../../public/images/registration.png"; // 👈 your image in assets
...
const RegisterPage = () => {
  ...
  const s = {
    ...
    termsText: { fontSize: "13px", color: "#050505" },
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.right}>
        ...
        {/* Heading */}
        <p style={s.welcomeText}>Get Started Now</p>
        <h1 style={s.heading}>Registration</h1>
        ...
        <label style={s.termsRow}>
          ...
          />
          <span style={s.termsText}>I agree to terms &amp; conditions</span>
        </label>

        {/* Submit */}
        <button style={s.submitBtn} onClick={handleRegister} disabled={loading}>
